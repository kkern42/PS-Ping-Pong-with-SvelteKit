<script>
	...
	let questions = [
...

		{
			...
			answer:
				'You can lose up to 1 match and still stay in the tournament. If you lose again,\
...
<div class="faq">
	<h1>FAQ</h1>
	<pre><div
			style="padding: 0 1rem 0 1rem;">Find the answers to all your burning questions.</div></pre>
	<Accordion>
